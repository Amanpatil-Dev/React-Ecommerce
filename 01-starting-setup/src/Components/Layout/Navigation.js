...
function Navigation(props) {
  ...
  const displayResponsiveNav = (e) => {
    const nav = e.target.closest('.responsive')
    if (!nav.firstElementChild.classList.contains('hidden')) {
      props.onBackdrop(true)
      setShowNav(true)
    } else {
      props.onBackdrop(false)
      setShowNav(false)
  ...
  return (
    <header className="nav-header container">
      <div className="nav-content d-flex">
        <div onClick={displayResponsiveNav} className='responsive'>
          <div className={`nav-ham mx-3 ${showNav ? 'hidden' : ''}`}>
          ...
          <div className={`close mx-3 ${!showNav ? 'hidden' : ''}`}>
        ...
        <div class={`nav-custom-items ${!showNav ? 'hidden' : ''}`}>

          <ul class="nav-custom-items-links">
            <li class="nav-link-custom mx-2">
              <a href="aman.com">
                Collection
              </a>
            </li>
            ...
            <li class="nav-link-custom mx-2">
              <a class="contact-link" href="aman.com">
                About
              </a>
            </li>
            <li class="nav-link-custom mx-2">
      ...
      <div className="nav-cart__profile">
        <CartButton />
        <img alt='avatar' className="img-fluid avatar mx-3" src={avatar} />
